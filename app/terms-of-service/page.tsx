    ...
    <div className="min-h-screen bg-vx-surface-elevated">
      <div className="max-w-3xl mx-auto px-4 py-12">
        <div className="bg-vx-surface rounded-lg shadow-sm p-8 md:p-12">
          <h1 className="text-3xl font-bold text-vx-text mb-2">Terms of Service</h1>
          <p className="text-sm text-vx-text-muted mb-8">Last updated: February 25, 2026</p>

          <div className="prose prose-gray max-w-none space-y-6">
            <section>
              <h2 className="text-xl font-semibold text-vx-text mt-8 mb-3">1. Acceptance of Terms</h2>
            ...
            <section>
              <h2 className="text-xl font-semibold text-vx-text mt-8 mb-3">2. Description of Service</h2>
              <p className="text-vx-text-secondary leading-relaxed">
            ...
            <section>
              <h2 className="text-xl font-semibold text-vx-text mt-8 mb-3">3. User Responsibilities</h2>
              <p className="text-vx-text-secondary leading-relaxed mb-3">By using the Service, you agree to:</p>
            ...
            <section>
              <h2 className="text-xl font-semibold text-vx-text mt-8 mb-3">4. WhatsApp Business API Usage</h2>
              <p className="text-vx-text-secondary leading-relaxed">
            ...
            <section>
              <h2 className="text-xl font-semibold text-vx-text mt-8 mb-3">5. Account & Access</h2>
              <p className="text-vx-text-secondary leading-relaxed">
            ...
            <section>
              <h2 className="text-xl font-semibold text-vx-text mt-8 mb-3">6. Data & Privacy</h2>
              <p className="text-vx-text-secondary leading-relaxed">
                Your use of the Service is also governed by our{' '}
                <a href="/privacy-policy" className="text-vx-purple hover:underline">Privacy Policy</a>. 
            ...
            <section>
              <h2 className="text-xl font-semibold text-vx-text mt-8 mb-3">7. Intellectual Property</h2>
              <p className="text-vx-text-secondary leading-relaxed">
            ...
            <section>
              <h2 className="text-xl font-semibold text-vx-text mt-8 mb-3">8. Limitation of Liability</h2>
              <p className="text-vx-text-secondary leading-relaxed">
            ...
            <section>
              <h2 className="text-xl font-semibold text-vx-text mt-8 mb-3">9. Service Availability</h2>
              <p className="text-vx-text-secondary leading-relaxed">
            ...
            <section>
              <h2 className="text-xl font-semibold text-vx-text mt-8 mb-3">10. Termination</h2>
              <p className="text-vx-text-secondary leading-relaxed">
            ...
            <section>
              <h2 className="text-xl font-semibold text-vx-text mt-8 mb-3">11. Changes to Terms</h2>
              <p className="text-vx-text-secondary leading-relaxed">
            ...
            <section>
              <h2 className="text-xl font-semibold text-vx-text mt-8 mb-3">12. Contact</h2>
              <p className="text-vx-text-secondary leading-relaxed">
